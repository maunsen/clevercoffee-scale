...
// Shot timer with or without scale
    ...
    float scaleDelayValue = 5;                          // value in gramm that takes still flows onto the scale after brew is stopped / value in seconds that the scale still measures after a shot
